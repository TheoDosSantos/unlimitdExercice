                    ...
                    <div class="container-text">
                        ...
                        <div class="container-btn">
                            <div class="btn">
                                ...
                                <a href="#" class="btn-text"><?= RichText::asText($document->hero_btntxt); ?></a>
                            </div>
                        </div>
                        ...
                        <div class="container-div">
                            ...
                            <div class="container-text">
                                ...
                                <div class="container-btn-video">
                                    ...
                                    <a href="" ><?= RichText::asText($document->solution_videotxt); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="container-btn">
                            <div class="btn">
                                ...
                                <a href="" class="btn-text"><?= RichText::asText($document->body2[0]->primary->btntxt); ?></a>
                            </div>
                        </div>
            ...
            <div class="section-4">
                <div class="wrapper">
                    <div class="container">
                        ...
                        <div class="cards">
                            <?php foreach ($document->produits_grp as $l) { ?>
                                <div class="card">
                                    ...
                                    <div class="container-btn">
                                        <div class="btn">
                                            ...
                                            <a href="" class="btn-text" ><?= RichText::asText($l->btntxt); ?></a>
                                        </div>
                                    </div>
                                    <img src="" alt="">
                                </div>
                            ...
                            <div class="container-cta">
                                ...
                                <div class="container-btn">
                                    <div class="btn">
                                        ...
                                        <a href="#" class="btn-text"><?= RichText::asText($document->cta_btntxt); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
